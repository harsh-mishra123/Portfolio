...
const Projects = () => {
  const projects = [
    ...
    },
    {
      id: 3,
      title: 'Chronovault',
      description: 'A decentralise react app to secure your files and info for future.',
    ...
    },
    {
      ...
      technologies: ['Next js', 'Clerk', 'Neondb', 'Postgres sql','API key'],
      githubLink: 'https://github.com/harsh-mishra123/AI-SKETCHMAKER',
      demoLink: 'https://ai-sketchmaker.vercel.app',
      featured: true
    },
    },
  ];
