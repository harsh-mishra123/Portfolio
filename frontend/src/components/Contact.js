...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      {/* Optimized Background - Reduced elements for better performance */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Animated Circles - Using CSS transform instead of multiple SVG animations */}
        ...
        <div className="absolute bottom-1/4 left-1/4 w-24 h-24 border border-purple-300 rounded-full opacity-15" style={{animation: 'ping 4s cubic-bezier(0, 0, 0.2, 1) infinite'}}></div>
        
        {/* Minimal Floating Icons - Reduced from 12 to 4 for performance */}
        <div className="absolute top-20 left-10 animate-pulse" style={{animationDelay: '0s', animationDuration: '3s'}}>
          <svg className="w-8 h-8 text-blue-300 opacity-20" fill="currentColor" viewBox="0 0 24 24">
            <path d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
          </svg>
        </div>
        
        <div className="absolute bottom-20 right-1/4 animate-pulse" style={{animationDelay: '2s', animationDuration: '4s'}}>
          <svg className="w-7 h-7 text-purple-300 opacity-20" fill="currentColor" viewBox="0 0 24 24">
            <path d="M20 2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h4v3c0 .6.4 1 1 1h.5c.2 0 .5-.1.7-.3L14.6 18H20c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z"/>
          </svg>
        </div>

        <div className="absolute top-60 right-20 animate-pulse" style={{animationDelay: '1s', animationDuration: '5s'}}>
          <svg className="w-6 h-6 text-cyan-300 opacity-15" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="absolute bottom-40 left-20 animate-pulse" style={{animationDelay: '3s', animationDuration: '6s'}}>
          <svg className="w-7 h-7 text-indigo-300 opacity-15" fill="currentColor" viewBox="0 0 24 24">
            <path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/>
          </svg>
        </div>
        
        {/* Simplified Floating Dots */}
        <div className="absolute top-1/3 left-1/5 w-2 h-2 bg-cyan-400 rounded-full animate-pulse opacity-30"></div>
        <div className="absolute bottom-1/3 right-1/5 w-2 h-2 bg-pink-400 rounded-full animate-pulse opacity-25"></div>
      </div>
